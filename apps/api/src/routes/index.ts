...
import logForwardersRoute from "./log-forwarders.js";
...
routes.route("/circuit-breaker", circuitBreaker);
routes.route("/video", video);
routes.route("/analytics", analytics);
routes.route("/orgs/:orgId/log-forwarders", logForwardersRoute);
routes.route("/rate-limits", rateLimitsRouter);
routes.route("/orgs", ssoRoutes);
